...
func (c *UpdateCertificatesRequest) GetAPIServerKubeletClientCert() string {
	return util.Deref(c.APIServerKubeletClientCert)
}
func (c *UpdateCertificatesRequest) GetAPIServerKubeletClientKey() string {
	return util.Deref(c.APIServerKubeletClientKey)
}
